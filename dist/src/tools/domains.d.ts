...
export declare function createDomain(input: CreateDomainInput): Promise<{
    ...
    updatedAt: Date;
    entityCount: number;
    entityTypes: import("@prisma/client/runtime/client").JsonValue | null;
    inclusionCriteria: string | null;
    exclusionCriteria: string | null;
    searchHints: string | null;
    knownLeaders: import("@prisma/client/runtime/client").JsonValue | null;
    relevantTopics: import("@prisma/client/runtime/client").JsonValue | null;

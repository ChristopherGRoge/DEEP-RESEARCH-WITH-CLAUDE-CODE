...
exports.fetchGitHubMetrics = fetchGitHubMetrics;
exports.fetchEntityGitHubMetrics = fetchEntityGitHubMetrics;
exports.fetchProjectGitHubMetrics = fetchProjectGitHubMetrics;
exports.getEntitiesByGitHubStars = getEntitiesByGitHubStars;
 ...
 */
async function findGitHubUrl(entityId) {
 ...
 */
async function fetchEntityGitHubMetrics(input) {
 ...
 */
async function fetchProjectGitHubMetrics(input) {
 ...
 */
async function getEntitiesByGitHubStars(input) {

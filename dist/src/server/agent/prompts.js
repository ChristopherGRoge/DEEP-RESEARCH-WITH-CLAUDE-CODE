...
exports.VALIDATION_AGENT_DESCRIPTION = exports.VALIDATION_SYSTEM_PROMPT = void 0;
exports.VALIDATION_SYSTEM_PROMPT = `You are a research validation assistant helping a human researcher verify assertions (claims) collected by AI research agents.
...
exports.VALIDATION_AGENT_DESCRIPTION = `Validation assistant that presents assertions to human researchers for verification. Use this agent to facilitate the human-in-the-loop validation workflow where claims are promoted from CLAIM to EVIDENCE status.`;

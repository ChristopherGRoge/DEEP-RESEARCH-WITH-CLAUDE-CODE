...
exports.VALIDATOR_PROMPTS = exports.FRESHNESS_AUDITOR_SYSTEM_PROMPT = exports.CROSS_REFERENCER_SYSTEM_PROMPT = exports.EVIDENCE_AUDITOR_SYSTEM_PROMPT = exports.CLAIM_CHALLENGER_SYSTEM_PROMPT = void 0;
exports.getValidatorPrompt = getValidatorPrompt;
/**
 ...
 */
exports.CLAIM_CHALLENGER_SYSTEM_PROMPT = `You are a claim challenger - an adversarial validator for research quality.
 ...
 */
exports.EVIDENCE_AUDITOR_SYSTEM_PROMPT = `You are an evidence auditor - quality control for research evidence.
 ...
 */
exports.CROSS_REFERENCER_SYSTEM_PROMPT = `You are a cross-referencer - independent verification specialist.
 ...
 */
exports.FRESHNESS_AUDITOR_SYSTEM_PROMPT = `You are a freshness auditor - staleness detector and refresh prioritizer.
 ...
 */
exports.VALIDATOR_PROMPTS = {
    CLAIM_CHALLENGER: exports.CLAIM_CHALLENGER_SYSTEM_PROMPT,
    EVIDENCE_AUDITOR: exports.EVIDENCE_AUDITOR_SYSTEM_PROMPT,
    CROSS_REFERENCER: exports.CROSS_REFERENCER_SYSTEM_PROMPT,
    FRESHNESS_AUDITOR: exports.FRESHNESS_AUDITOR_SYSTEM_PROMPT,
};
/**
 * Get validator prompt by name
 */
function getValidatorPrompt(name) {
    return exports.VALIDATOR_PROMPTS[name];
}
//# sourceMappingURL=validator-prompts.js.map
...
**Template Note:** This template follows the structure and styling established in Harness Platform Efficacy Brief. Typography sized for readability (h2: 2.2em, h3: 1.7em, p: 1.1em). Tables use purple gradient headers. Callouts sized at 1.2em for prominence.
...
**Recommendation Summary - [TOOL NAME]:**
